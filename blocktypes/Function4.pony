...
actor Function4Block is Block
  ...
  be update(input: String, new_value:Any val) =>
    _context(Fine) and _context.log("Function4[ " + _name + "." + input + " = " + try (new_value as Stringable).string() else "<not stringable>" end + " ]")
    match input
...
class val Function4BlockDescriptor is BlockTypeDescriptor
  ...
  new val create(blockname:String, block_description:String,
      ...
      _in3 = InputDescriptor(name3, type3, descr3, false, true )
      _in4 = InputDescriptor(name4, type4, descr4, false, true )
