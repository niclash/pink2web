...
declare class PrintPreview {
    constructor(graph: Graph, scale?: number | null, pageFormat?: Rectangle | null, border?: number | null, x0?: number, y0?: number, borderColor?: string | null, title?: string, pageSelector?: boolean | null);
    /**
     ...
     */
    appendGraph(graph: Graph, scale: number, x0: number, y0: number, forcePageBreaks: boolean, keepOpen: boolean): void;
    /**
